...
\chapter{Dobór optymalnego modelu}
...
\section{Wyniki symulacji dla sezonów zasadniczych}
...
\section{Wyniki symulacji dla fazy Playoff}
Dla wybranych w poprzedniej części modeli i parametrów przeprowadzona została symulacja rozgrywek pucharowych, korzystając z algorytmów zdefiniowanych w Rozdziale \ref{modele_palyoff}. w TABELACH REFY!!! porównano przewidziane na ich podstawie serie wraz z rzeczywistym przebiegiem rozgrywek w 2018 roku. 
...
\begin{table}[]
	...
	\begin{tabular}{ |c|c|c|  }
		\hline
		\multicolumn{3}{|c|}{\textbf{Prognozy dla Modelu I}} \\\hline
		\multicolumn{3}{|c|}{} \\\hline	
	...
	\begin{tabular}{|c|c|c|}
	\hline
	\multicolumn{3}{|c|}{\textbf{Prognozy dla Modelu II}} \\\hline
	\multicolumn{3}{|c|}{} \\\hline	
	\textbf{Model IV}& \textbf{Model V} &\textbf{Rzeczywistość}\\\hline	
