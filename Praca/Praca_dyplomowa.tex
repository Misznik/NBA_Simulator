...
\streszczenieang{The main subject of the thesis concerns the recent problem from applied mathematics field --- creation of NBA leauge simulator usung known mathematical/ststistical techiques. The goal is to design a simulator based on bootstrap methods, with the result being software capable of predicting outcome of a NBA season in the next year.}
\slowakluczowe{statystyka, bootstrap, symulacje Monte Carlo, estymacja rozkładu, symulacja wyników koszykarskich}  
\slowakluczoweang{statistics, bootstrap, Monte Carlo simulations, estimation of distribution, simulation of basketball outcomes}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%\begin{figure}[t]
%	\hspace*{-3cm}  
%	\includegraphics[width=22cm]{m1_dla14_5lat_waga0_box_wschod.pdf}
...
%\begin{figure}[t]
%	\hspace*{-3cm}  
%	\includegraphics[width=22cm]{m1_dla14_5lat_waga05_box_wschod.pdf}
%	\caption{Model I, 5 lat, waga 0,5}
%	\centering
%\end{figure}
%
%\begin{figure}[t]
%	\hspace*{-3cm}  
%	\includegraphics[width=22cm]{m1_dla14_5lat_waga05_box_zachod.pdf}
%	\caption{Model I, 5 lat, waga 0,5}
%	\centering
%\end{figure}
%
%\begin{figure}[t]
%	\hspace*{-3cm}  
%	\includegraphics[width=22cm]{m1_dla14_5lat_waga1_box_wschod.pdf}
%	\caption{Model I, 5 lat, waga 1}
%	\centering
%\end{figure}
%
%\begin{figure}[t]
%	\hspace*{-3cm}  
%	\includegraphics[width=22cm]{m1_dla14_5lat_waga1_box_zachod.pdf}
%	\caption{Model I, 5 lat, waga 1}
%	\centering
%\end{figure}
%
...
%\begin{figure}[t]
%	\hspace*{-3cm}  
%	\includegraphics[width=22cm]{m1_dla14_10lat_waga0_box_wschod.pdf}
%	\caption{Model I, 10 lat, waga 0}
%	\centering
%\end{figure}
%
%\begin{figure}[t]
...
%\begin{figure}[t]
%	\hspace*{-3cm}  
%	\includegraphics[width=22cm]{m1_dla14_10lat_waga05_box_wschod.pdf}
%	\caption{Model I, 10 lat, waga 0,5}
%	\centering
%\end{figure}
%
%\begin{figure}[t]
%	\hspace*{-3cm}  
%	\includegraphics[width=22cm]{m1_dla14_10lat_waga05_box_zachod.pdf}
%	\caption{Model I, 10 lat, waga 0,5}
%	\centering
%\end{figure}
%
%\begin{figure}[t]
%	\hspace*{-3cm}  
%	\includegraphics[width=22cm]{m1_dla14_10lat_waga1_box_wschod.pdf}
%	\caption{Model I, 10 lat, waga 1}
%	\centering
%\end{figure}
%
%\begin{figure}[t]
%	\hspace*{-3cm}  
%	\includegraphics[width=22cm]{m1_dla14_10lat_waga1_box_zachod.pdf}
%	\caption{Model I, 10 lat, waga 1}
%	\centering
%\end{figure}
%
...
%\begin{figure}[t]
%	\hspace*{-3cm}  
%	\includegraphics[width=22cm]{m1_dla17_5lat_waga0_box_wschod.pdf}
%	\caption{Model I, 5 lat, waga 0}
%	\centering
%\end{figure}
%
...
%\begin{figure}[t]
%	\hspace*{-3cm}  
%	\includegraphics[width=22cm]{m1_dla17_5lat_waga05_box_wschod.pdf}
%	\caption{Model I, 5 lat, waga 0,5}
%	\centering
%\end{figure}
%
%\begin{figure}[t]
%	\hspace*{-3cm}  
%	\includegraphics[width=22cm]{m1_dla17_5lat_waga05_box_zachod.pdf}
%	\caption{Model I, 5 lat, waga 0,5}
%	\centering
%\end{figure}
%
...
%\begin{figure}[t]
%	\hspace*{-3cm}  
%	\includegraphics[width=22cm]{m1_dla17_10lat_waga0_box_wschod.pdf}
%	\caption{Model I, 10 lat, waga 0}
%	\centering
%\end{figure}
%
...
%\begin{figure}[t]
%	\hspace*{-3cm}  
%	\includegraphics[width=22cm]{m1_dla17_10lat_waga05_box_wschod.pdf}
%	\caption{Model I, 10 lat, waga 0,5}
%	\centering
%\end{figure}
%
%\begin{figure}[t]
%	\hspace*{-3cm}  
%	\includegraphics[width=22cm]{m1_dla17_10lat_waga05_box_zachod.pdf}
%	\caption{Model I, 10 lat, waga 0,5}
%	\centering
%\end{figure}
%
%\begin{figure}[t]
%	\hspace*{-3cm}  
%	\includegraphics[width=22cm]{m1_dla17_10lat_waga1_box_wschod.pdf}
%	\caption{Model I, 10 lat, waga 1}
%	\centering
%\end{figure}
%
%\begin{figure}[t]
%	\hspace*{-3cm}  
%	\includegraphics[width=22cm]{m1_dla17_10lat_waga1_box_zachod.pdf}
%	\caption{Model I, 10 lat, waga 1}
%	\centering
%\end{figure}
%
...
%\begin{figure}[t]
%	\hspace*{-3cm}  
%	\includegraphics[width=22cm]{m2_dla14_5lat_waga0_box_wschod.pdf}
%	\caption{Model II, 5 lat, waga 0}
%	\centering
%\end{figure}
%
%\begin{figure}[t]
...
%\begin{figure}[t]
%	\hspace*{-3cm}  
%	\includegraphics[width=22cm]{m2_dla14_5lat_waga05_box_wschod.pdf}
%	\caption{Model II, 5 lat, waga 0,5}
%	\centering
%\end{figure}
%
%\begin{figure}[t]
%	\hspace*{-3cm}  
%	\includegraphics[width=22cm]{m2_dla14_5lat_waga05_box_zachod.pdf}
%	\caption{Model II, 5 lat, waga 0,5}
%	\centering
%\end{figure}
%
%\begin{figure}[t]
%	\hspace*{-3cm}  
%	\includegraphics[width=22cm]{m2_dla14_5lat_waga1_box_wschod.pdf}
%	\caption{Model II, 5 lat, waga 1}
%	\centering
%\end{figure}
%
%\begin{figure}[t]
%	\hspace*{-3cm}  
%	\includegraphics[width=22cm]{m2_dla14_5lat_waga1_box_zachod.pdf}
%	\caption{Model II, 5 lat, waga 1}
%	\centering
%\end{figure}
%
...
%\begin{figure}[t]
%	\hspace*{-3cm}  
%	\includegraphics[width=22cm]{m2_dla14_10lat_waga0_box_wschod.pdf}
%	\caption{Model II, 10 lat, waga 0}
%	\centering
%\end{figure}
%
%\begin{figure}[t]
...
%\begin{figure}[t]
%	\hspace*{-3cm}  
%	\includegraphics[width=22cm]{m2_dla14_10lat_waga05_box_wschod.pdf}
%	\caption{Model II, 10 lat, waga 0,5}
%	\centering
%\end{figure}
%
%\begin{figure}[t]
%	\hspace*{-3cm}  
%	\includegraphics[width=22cm]{m2_dla14_10lat_waga05_box_zachod.pdf}
%	\caption{Model II, 10 lat, waga 0,5}
%	\centering
%\end{figure}
%
%\begin{figure}[t]
%	\hspace*{-3cm}  
%	\includegraphics[width=22cm]{m2_dla14_10lat_waga1_box_wschod.pdf}
%	\caption{Model II, 10 lat, waga 1}
%	\centering
%\end{figure}
%
%\begin{figure}[t]
%	\hspace*{-3cm}  
%	\includegraphics[width=22cm]{m2_dla14_10lat_waga1_box_zachod.pdf}
%	\caption{Model II, 10 lat, waga 1}
%	\centering
%\end{figure}
%
...
%\begin{figure}[t]
%	\hspace*{-3cm}  
%	\includegraphics[width=22cm]{m2_dla17_5lat_waga0_box_wschod.pdf}
%	\caption{Model II, 5 lat, waga 0}
%	\centering
%\end{figure}
%
...
%\begin{figure}[t]
%	\hspace*{-3cm}  
%	\includegraphics[width=22cm]{m2_dla17_5lat_waga05_box_wschod.pdf}
%	\caption{Model II, 5 lat, waga 0,5}
%	\centering
%\end{figure}
%
%\begin{figure}[t]
%	\hspace*{-3cm}  
%	\includegraphics[width=22cm]{m2_dla17_5lat_waga05_box_zachod.pdf}
%	\caption{Model II, 5 lat, waga 0,5}
%	\centering
%\end{figure}
%
%\begin{figure}[t]
%	\hspace*{-3cm}  
%	\includegraphics[width=22cm]{m2_dla17_5lat_waga1_box_wschod.pdf}
%	\caption{Model II, 5 lat, waga 1}
%	\centering
%\end{figure}
%
%\begin{figure}[t]
%	\hspace*{-3cm}  
%	\includegraphics[width=22cm]{m2_dla17_5lat_waga1_box_zachod.pdf}
%	\caption{Model II, 5 lat, waga 1}
%	\centering
%\end{figure}
%
...
%\begin{figure}[t]
%	\hspace*{-3cm}  
%	\includegraphics[width=22cm]{m2_dla17_10lat_waga0_box_wschod.pdf}
%	\caption{Model II, 10 lat, waga 0}
%	\centering
%\end{figure}
%
...
%\begin{figure}[t]
%	\hspace*{-3cm} 
%	\includegraphics[width=22cm]{m2_dla17_10lat_waga1_box_wschod.pdf}
%	\caption{Model II, 10 lat, waga 1}
%	\centering
%\end{figure}
%
%\begin{figure}[t]
%	\hspace*{-3cm}  
%	\includegraphics[width=22cm]{m2_dla17_10lat_waga1_box_zachod.pdf}
%	\caption{Model II, 10 lat, waga 1}
%	\centering
%\end{figure}
